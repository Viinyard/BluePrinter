...
public class FileUtils {
     ...
     * @throws VelocityBlueprintException if an error occurs during loading
     */
    private static <T> T loadConfiguration(Source source, Class<T> environmentClass, String schemaLocation) throws VelocityBlueprintException {
        try {
            ...
            return Optional.of(unmarshaller.unmarshal(source)).filter(environmentClass::isInstance).map(environmentClass::cast).orElseThrow(() -> new VelocityBlueprintException("Invalid configuration file"));
