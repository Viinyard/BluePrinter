package dev.vinyard.blueprinter.shell.core.environment;
...
import dev.vinyard.blueprinter.shell.support.DirectoryInput;
...
public class EnvironnementShellComponent extends AbstractShellComponent {
     ...
     *      <li>Creating the model directory in the workspace, named {@link EnvironmentConfiguration#workspaceDirectory()}</li>
