...
public class ModelManager {
     ...
     * @throws VelocityBlueprintException if the model is not valid
     */
     ...
     * @throws VelocityBlueprintException if the model configuration file is not valid
     */
     ...
     * @throws VelocityBlueprintException if an error occurs during the loading
